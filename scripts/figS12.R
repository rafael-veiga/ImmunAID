...
dis = list(var = c("Healthy","Autoinflammation of unknown origin","Still's disease","FMF","Behcet"),
           ...
           pos_refx1 = c(NA,0.5,0.4,0.4,0.5),
           pos_refy1 =c(NA,0,1.7,0,1),
           pos_refx2 = c(NA,0.8,0.4,0,0.25),
           pos_refy2 =c(NA,1.5,0,1.5,0))
...
pdf("./figS12.pdf", family=font,width = 13.5,height = 12)
print(p)
dev.off()
